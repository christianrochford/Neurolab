        ...
        return {
            ...
            callback: function (e) {
                ...
                for (a = 0; a < d;) {
                    ...
                    b = "";
                    s ? (r && (b += '<div class="user">' + x(g[a].innerHTML) + "</div>"), b += '<p class="tweet">' + x(e[a].innerHTML) + "</p>", q && (b += '<p class="timePosted">' + f[a].getAttribute("aria-label") + "</p>")) : e[a].innerText ? (r && (b += '<p class="user">' + g[a].innerText + "</p>"), b += '<p class="tweet">' + e[a].innerText + "</p>", q && (b += '<p class="timePosted">' + f[a].innerText + "</p>")) : (r && (b += '<p class="user">' + g[a].textContent + "</p>"), b += '<p class="tweet">' + e[a].textContent + "</p>", q && (b += '<p class="timePosted">' + f[a].textContent + "</p>"));
...
// hashtags.
twitterFetcher.fetch('440511694112956416', 'tweets', 4, true, false, false, 'default', true, handleTweets, false);

function handleTweets(tweets){
    var x = tweets.length;
    var n = 0;
    var element = document.getElementById('tweets');
    var html = '<ul id="tweet-wrapper" class="slides">';
    while(n < x) {
      html += '<li id="tweet' + n + '" class="tweet"><div class="text-wrapper">' + tweets[n] + '<a id="twitter-link" href="https://twitter.com/BestmannLab" target="_blank"><span class="icon-twitter" aria-hidden="true"></span>@BestmannLab</a></div></li>';
      n++;
    }
    html += '</ul>';
